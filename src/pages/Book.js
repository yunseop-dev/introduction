...
const Hobby = () => {
    return <MainSection>
        <div style={{ display: 'flex' }}>
            <img style={{ objectFit: 'cover' }} src="https://static.scientificamerican.com/sciam/cache/file/1DDFE633-2B85-468D-B28D05ADAE7D1AD8_source.jpg?w=590&h=800&D80F3D79-4382-49FA-BE4B4D0C62A5C3ED" width="400" alt='books' />
            <Wrapper>
                <h1>
                ...
                <p>
                    <Ruby
                        text="서점 가는 것도 좋아합니다."
                        translation="I also like to go to the bookstore."
                    />
                </p>
                <h3>
                    <Ruby
